...
class M51sami extends ComicSource {
  name = "51漫画";
  key = "legacy_51sami";
  version = "0.1.0";
  minAppVersion = "1.6.0";
  url = "";
  get baseUrl() { return "https://m.51sami.com"; }
  ...
  parseCards(doc, base) {
    const comics = [];
    for (const card of doc.querySelectorAll(".itemBox, .list-comic")) {
  ...
  comic = {
    loadInfo: async (id) => {
      ...
      const tags = { "作者": [], "类型": [] };
      for (const dd of doc.querySelectorAll(".pic dd, .pic_zi dd")) { const t = this.text(dd); if (t && t.length < 30) tags["作者"].push(t); }
