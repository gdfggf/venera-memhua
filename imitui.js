...
class Imitui extends ComicSource {
  name = "爱米推漫画";
  key = "legacy_imitui";
  version = "0.1.0";
  minAppVersion = "1.6.0";
  url = "";
  get baseUrl() { return "https://m.imitui.com"; }
  ...
  comic = {
    ...
    loadEp: async (comicId, epId) => {
      ...
      while (url && guard < 20) {
        ...
        for (const img of doc.querySelectorAll("#image img, .scroll-item img, .erPag mip-img, .erPag img, .comicpage img")) {
