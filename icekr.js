...
class Icekr extends ComicSource {
  name = "冰氪漫画";
  key = "legacy_icekr";
  version = "0.1.0";
  minAppVersion = "1.6.0";
  url = "";
  get baseUrl() { return "https://m.icekr.com"; }
  ...
  comic = {
    ...
    loadEp: async (comicId, epId) => {
      ...
      while (url && guard < 20) {
        ...
        for (const img of doc.querySelectorAll("#images img, .erPag mip-img, .erPag img, .comicpage img")) {
