...
class M85iu extends ComicSource {
  name = "85漫画网";
  key = "legacy_85iu";
  version = "0.1.0";
  minAppVersion = "1.6.0";
  url = "";
  get baseUrl() { return "https://m.85iu.com"; }
  ...
  parseCards(doc, base) {
    const comics = [];
    for (const card of [...doc.querySelectorAll("#update_list .itemBox"), ...doc.querySelectorAll(".itemBox"), ...doc.querySelectorAll(".list-comic")]) {
